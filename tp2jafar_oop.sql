...
-- Dumping database structure for tp2jafar_oop
CREATE DATABASE IF NOT EXISTS `tp2jafar_oop` /*!40100 DEFAULT CHARACTER SET utf8mb4 */;
USE `tp2jafar_oop`;

-- Dumping structure for table tp2jafar_oop.tbl_kabkota
...
-- Dumping data for table tp2jafar_oop.tbl_kabkota: ~32 rows (approximately)
...
-- Dumping structure for table tp2jafar_oop.tbl_provinsi
...
-- Dumping data for table tp2jafar_oop.tbl_provinsi: ~2 rows (approximately)
